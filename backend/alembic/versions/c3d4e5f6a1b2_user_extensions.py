"""user extensions: email/last_login/webauthn, passkey credentials, artwork imported_by, post_log user
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('artworks', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_artworks_imported_by_id'), ['imported_by_id'], unique=False)
    ...
    with op.batch_alter_table('bot_post_logs', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_bot_post_logs_posted_by_user_id'), ['posted_by_user_id'], unique=False)
        batch_op.create_foreign_key(
