...
from app.api.links import admin_router as links_admin_router
from app.api.links import public_router as links_public_router
...
api_router.include_router(links_public_router, prefix="/links", tags=["links"])
...
api_router.include_router(links_admin_router, prefix="/admin", tags=["admin"])
